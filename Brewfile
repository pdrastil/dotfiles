...
brew "zsh"                  # Z shell, a UNIX command interpreter
...
cask "docker"               # Build and share containerized applications
cask "parallels"            # Parallels Desktop
cask "vagrant"              # Reusable development environment
cask "vagrant-manager"      # Manager for Vagrant machines

#===================================================
# Amazon Web Services
#===================================================
brew "awscli"               # Official Amazon AWS command-line interface
cask "aws-vault"            # Amazon AWS IAM password manager
...
brew "terragrunt"           # Tool to make Terraform configurations DRY
